...
def predict_image(image_path, model_path, label_file_path, output_path):
    ...
    plt.suptitle(f"DL Classification\nClass Predicted: {predicted_label}", fontsize=14)
    plt.tight_layout()
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage: python predict.py <image_path> <model_path> <label_file_path> <output_path>")
        exit(1)
